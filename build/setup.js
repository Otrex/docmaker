...
const takeSecond = (variable) => variable.split('=')[1];
...
`;
if (!fs_1.default.existsSync(`${store}/../documentation`)) {
    fs_1.default.mkdirSync(`${store}/../documentation`);
}
fs_1.default.writeFileSync(path_1.default.join(__dirname, './config.ts'), data);
fs_1.default.writeFileSync(path_1.default.join(__dirname, './config.js'), data);
